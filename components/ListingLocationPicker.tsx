...
const ListingLocationPicker = forwardRef<ListingLocationPickerHandle, Props>(
  function ListingLocationPicker({
    initialLocation,
    onConfirm,
  }, ref) {
    ...
    <div className="mv-step5">
      <div className="mv-step5-map-shell">
        ...
        <div className="mv-step5-modes">
          <select
            ...
            value={mapMode}
            onChange={(e) =>
              setMapMode(e.target.value as keyof typeof MAP_MODES)
            }
          >
      ...
      <style jsx global>{`
        ...
        .mv-step5-modes {
          ...
          align-items: center;
          padding: 3px;
          border: 1px solid rgba(210,218,214,.95);
          border-radius: 12px;
        ...
        .mv-step5-modes select:focus {
          border-color: #29ab87;
          box-shadow: 0 0 0 2px rgba(41,171,135,.14);
        }
        ...
        .mv-location-error {
          ...
          box-shadow: 0 2px 7px rgba(180,35,24,.07) !important;
        }
        ...
        .mv-step5-map-shell .leaflet-control-attribution {
          right: 7px !important;
        ...
        .mv-step5-map-shell {
          ...
          border-radius: 16px;
          box-shadow: 0 5px 18px rgba(20, 40, 32, .08);
          overflow: hidden;
        }
        ...
        .mv-step5-location-card {
          ...
          border-radius: 14px;
          background: #fff;
          box-shadow: 0 4px 14px rgba(20,40,32,.06);
        }
        ...
        .mv-step5-modes {
          ...
          gap: 2px !important;
          border: 1px solid rgba(210,218,214,.75) !important;
          border-radius: 9px !important;
          background: rgba(255,255,255,.96) !important;
