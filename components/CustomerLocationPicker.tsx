...
export default function CustomerLocationPicker({
    ...
    <div className="listing-location-picker">
      ...
      <div className="map-area">
        <div className="map-search-overlay customer-map-search">
          <div className="search-row" style={{pointerEvents:"auto"}}>
        ...
        <div className="map-mode-control">
          <select
            value={mapMode}
            onChange={(event) =>
              setMapMode(event.target.value as keyof typeof MAP_MODES)
            }
  ...
  box-shadow: 0 4px 16px rgba(0,0,0,.14);
      ...
      .customer-map-search .search-button {
  ...
  pointer-events: auto !important;
      ...
      .floating-location-button {
        ...
        .listing-picker-map .leaflet-control {
          z-index: 900 !important;
        }

        .listing-picker-map .leaflet-control-container {
          z-index: 900 !important;
        }
        ...
        .map-search-overlay { position:absolute !important; top:8px !important; left:8px !important; right:8px !important; z-index:2000 !important; display:block !important; visibility:visible !important; opacity:1 !important; pointer-events:none !important; }
        .map-search-overlay .search-row { display:flex !important; width:100% !important; gap:5px !important; pointer-events:auto !important; }
        .map-search-overlay .search-box { flex:1 !important; min-width:0 !important; height:36px !important; }
        .map-search-overlay .search-button { flex:0 0 auto !important; height:36px !important; padding:0 11px !important; font-size:12px !important; }
        .map-mode-control { position:absolute !important; left:10px !important; top:72px !important; z-index:1900 !important; display:flex !important; flex-direction:column !important; align-items:stretch !important; gap:4px !important; padding:5px !important; border-radius:12px !important; background:rgba(255,255,255,.95) !important; box-shadow:0 3px 12px rgba(0,0,0,.16) !important; }
        .map-mode-control button { display:flex !important; align-items:center !important; justify-content:flex-start !important; width:105px !important; min-height:34px !important; padding:7px 9px !important; border:0 !important; border-radius:8px !important; white-space:nowrap !important; }
        .map-mode-control button span { display:inline !important; }


        /* CUSTOMER MAP CLEANUP */
        .map-area {
          position:relative !important;
          width:100% !important;
        ...
        .listing-picker-map .leaflet-control-zoom {
          display:none !important;
        }

        .listing-picker-map .leaflet-control-attribution {
          z-index:2 !important;
          font-size:8px !important;
        }
