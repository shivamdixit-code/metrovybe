              ...
              <section className="form-section">
                <div className="section-title">
                  ...
                  <div>
                    <h2>Photos</h2>
                    <p>
                      Add photos that help customers trust your listing.
                    </p>
                  </div>
                </div>
                ...
                <div className="listing-photo-upload-grid">
                  <div className="listing-photo-field">
                    ...
                    {form.image ? (
                      <div className="listing-image-preview main-preview">
                  ...
                  <div className="listing-photo-field">
                    ...
                    <div className="additional-images-grid">
                      {form.images
                        ...
                        .map((url) => (
                          <div
                            className="listing-image-preview additional-preview"
                            key={url}
                          >
                      ...
                      {form.images
                        ...
                        <label className="listing-upload-box additional-upload">
                          <input
                            type="file"
                            accept="image/jpeg,image/png,image/webp"
                            multiple
                          ...
                          <small>Up to 4 additional photos</small>
                        </label>
                      )}
                    </div>
                  </div>
                ...
                {photoUploadError && (
                  <p className="photo-upload-error">
                    {photoUploadError}
                  </p>
                )}
              </section>
